...
def execute(filters=None):
	...
	if branch_filter == None:
		...
		data = frappe.get_all('Inventory Count', filters=filters, fields=['date', 'in_count_a','principal_in_a', 'out_count_a','principal_out_a', 'returned_a','principal_ret_a', 'pulled_out_a','principal_po_a', 'total_a'], order_by='date desc')
