...
def execute(filters=None):
	...
	if branch_filter == None:
		...
		data = frappe.get_all('Inventory Count', filters={'branch':branch},  fields=['date', 'in_count_b', 'principal_in_b','out_count_b','principal_out_b', 'returned_b','principal_ret_b', 'pulled_out_b', 'principal_po_b','total_b'], order_by='date desc',)
	else:
		data = frappe.get_all('Inventory Count', filters=filters,  fields=['date', 'in_count_b', 'principal_in_b','out_count_b','principal_out_b', 'returned_b','principal_ret_b', 'pulled_out_b', 'principal_po_b','total_b'], order_by='date desc',)
